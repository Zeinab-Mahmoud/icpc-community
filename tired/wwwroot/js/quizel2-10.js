const questions = [
    {
        question: "stable_sort() preserves which of the following?",
        code: "",
        answer: "Value order\n\nOriginal position of equal elements\n\nIndex-based access\n\nMemory layout",
        correctAnswer: "Original position of equal elements"
    },
    {
        question: "In merge sort, why is extra space needed?",
        code: "",
        answer: "For recursion only\n\nFor merging arrays\n\nFor tracking indices\n\nTo avoid segmentation fault",
        correctAnswer: "For merging arrays"
    },
    {
        question: "What will map.lower_bound(x) return if x not present?",
        code: "",
        answer: "Iterator to lower\n\nIterator to x\n\nIterator to first > x\n\nIterator to first ≥ x",
        correctAnswer: "Iterator to first ≥ x"
    },
    {
        question: "Why is quick sort worst case O(n²)?",
        code: "",
        answer: "Extra memory\n\nPoor pivot selection\n\nWrong base case\n\nToo many function calls",
        correctAnswer: "Poor pivot selection"
    },
    {
        question: "What’s a disadvantage of unordered_map vs map?",
        code: "",
        answer: "No sorting\n\nSlower insert\n\nDuplicate keys\n\nHigh memory",
        correctAnswer: "No sorting"
    },
    {
        question: "Which STL uses red-black trees internally?",
        code: "",
        answer: "unordered_map\n\nset\n\nunordered_set\n\nvector",
        correctAnswer: "set"
    },
    {
        question: "If frequency of all values is known, how do you find most frequent element in O(n)?",
        code: "",
        answer: "Map scan\n\nPrefix sum\n\nLinear max\n\nBubble sort",
        correctAnswer: "Linear max"
    },
    {
        question: "Why is merge sort always O(n log n)?",
        code: "",
        answer: "Constant recursion depth\n\nAlways balanced\n\nWorst = average = best\n\nSpace efficient",
        correctAnswer: "Always balanced"
    },
    {
        question: "What’s a drawback of STL set for duplicate values?",
        code: "",
        answer: "Crashes\n\nRandom behavior\n\nIgnores duplicates\n\nDoesn’t sort",
        correctAnswer: "Ignores duplicates"
    },
    {
        question: "STL multiset allows:",
        code: "",
        answer: "Unordered insert\n\nUnique keys\n\nSorted duplicates\n\nHashing",
        correctAnswer: "Sorted duplicates"
    }
];
