const questions = [
    {
        question: 'scanf("%d", &x); is used for:',
        code: "",
        answer: "Print value\n\nTake string\n\nInput integer\n\nFormat date",
        correctAnswer: "Input integer"
    },
    {
        question: "Which STL uses heap internally?",
        code: "",
        answer: "set\n\npriority_queue\n\nmap\n\nqueue",
        correctAnswer: "priority_queue"
    },
    {
        question: "Which STL is best for range queries with fast insert?",
        code: "",
        answer: "vector\n\nmap\n\nset\n\nunordered_map",
        correctAnswer: "set"
    },
    {
        question: "compare function is passed to sort() as:",
        code: "",
        answer: "Loop\n\nPointer\n\nLambda/function\n\nIterator",
        correctAnswer: "Lambda/function"
    },
    {
        question: "In merge sort, the array is divided:",
        code: "",
        answer: "By 3\n\nIn half\n\nLinearly\n\nBased on values",
        correctAnswer: "In half"
    },
    {
        question: "STL map is implemented as:",
        code: "",
        answer: "Array\n\nStack\n\nRed-Black Tree\n\nHash Table",
        correctAnswer: "Red-Black Tree"
    },
    {
        question: "Which sort has best-case O(n) when array is sorted?",
        code: "",
        answer: "bubble\n\nselection\n\ninsertion\n\nmerge",
        correctAnswer: "insertion"
    },
    {
        question: "Coordinate Compression is useful for:",
        code: "",
        answer: "Sorting strings\n\nMapping large values to smaller indices\n\nSearching\n\nSwapping values",
        correctAnswer: "Mapping large values to smaller indices"
    },
    {
        question: "STL set<int>::find(x) returns:",
        code: "",
        answer: "Index\n\nBoolean\n\nIterator\n\nValue",
        correctAnswer: "Iterator"
    },
    {
        question: "What is a constraint in a problem statement?",
        code: "",
        answer: "Output format\n\nLimits on input\n\nSorting order\n\nReturn type",
        correctAnswer: "Limits on input"
    }
];
