const questions = [
    {
        question: "Which container works with LIFO (Last-In-First-Out)?",
        code: "",
        answer: "queue\n\nstack\n\nset\n\nvector",
        correctAnswer: "stack"
    },
    {
        question: "Which STL works as FIFO (First-In-First-Out)?",
        code: "",
        answer: "stack\n\nset\n\nqueue\n\nmap",
        correctAnswer: "queue"
    },
    {
        question: "What does map<int, string> store?",
        code: "",
        answer: "Integers only\n\nStrings only\n\nKey-value pairs\n\nOnly keys",
        correctAnswer: "Key-value pairs"
    },
    {
        question: "What does set automatically remove?",
        code: "",
        answer: "Even numbers\n\nZeros\n\nDuplicates\n\nNegative numbers",
        correctAnswer: "Duplicates"
    },
    {
        question: "What is the purpose of priority_queue?",
        code: "",
        answer: "Sort the array\n\nAlways keep the largest element on top\n\nStore elements in order\n\nRemove duplicates",
        correctAnswer: "Always keep the largest element on top"
    },
    {
        question: "What is the time complexity of bubble sort (worst case)?",
        code: "",
        answer: "O(n)\n\nO(n log n)\n\nO(n^2)\n\nO(log n)",
        correctAnswer: "O(n^2)"
    },
    {
        question: "Which sorting method is based on dividing array?",
        code: "",
        answer: "Bubble sort\n\nSelection sort\n\nMerge sort\n\nInsertion sort",
        correctAnswer: "Merge sort"
    },
    {
        question: "What does compare function in sort() decide?",
        code: "",
        answer: "Loop end\n\nPrint format\n\nOrder of elements\n\nNumber of inputs",
        correctAnswer: "Order of elements"
    },
    {
        question: "Which STL keeps key-value pairs sorted by key?",
        code: "",
        answer: "unordered_map\n\nvector\n\nmap\n\nstack",
        correctAnswer: "map"
    },
    {
        question: "What is the default order of sort() in C++?",
        code: "",
        answer: "Descending\n\nRandom\n\nAscending\n\nBased on string",
