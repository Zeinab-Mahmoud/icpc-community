const questions = [
    { 
        question: "Which of the following loops is preferred when the number of iterations is unknown beforehand?", 
        code: "", 
        answer: "for\n\nwhile\n\ndo-while\n\nAll of the above" 
    },
    ...
    { 
        question: "What will happen when this program is executed?", 
        code: "void testFunc() {\n    static int x = 0;\n    x++;\n    cout << x << \" \";\n}\nint main() {\n    testFunc();\n    testFunc();\n    testFunc();\n    return 0;\n}", 
        answer: "1 1 1\n\n0 1 2\n\n1 2 3\n\nCompilation error" 
    },
    
    { 
        question: "Which of the following is not an advantage of Object-Oriented Programming (OOP) in C++?", 
        code: "", 
        answer: "Code becomes more organized and reusable\n\nImproves processor performance\n\nMakes maintenance and modifications easier\n\nReduces programming complexity" 
    },
    ...
    { 
        question: "What is the best way to find all possible combinations of a set of elements in C++?", 
        code: "", 
        answer: "Using next_permutation\n\nIterating with for loops\n\nUsing recursion with backtracking\n\nSorting then searching" 
    },
