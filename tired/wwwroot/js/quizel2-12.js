const questions = [
    {
        question: "In priority_queue, what does pop() return?",
        code: "",
        answer: "Removed value\n\nIterator\n\nNothing\n\nTop value",
        correctAnswer: "Nothing"
    },
    {
        question: "A vector<pair<int, int>> sorted by second value needs:",
        code: "",
        answer: "sort with custom comparator\n\nmap\n\nprefix sum\n\nbubble sort",
        correctAnswer: "sort with custom comparator"
    },
    {
        question: "Sorting a vector<map<string, int>> requires:",
        code: "",
        answer: "Stable sort\n\nCustom comparator\n\nIterator\n\nSTL merge",
        correctAnswer: "Custom comparator"
    },
    {
        question: "Why does C++ STL sort require random-access iterators?",
        code: "",
        answer: "For pointer arithmetic\n\nTo allow heap usage\n\nFor efficient indexing\n\nTo optimize recursion",
        correctAnswer: "For efficient indexing"
    },
    {
        question: "If vector<int> v = {3, 1, 2}, how many swaps in bubble sort?",
        code: "",
        answer: "1\n\n2\n\n3\n\n4",
        correctAnswer: "3"
    },
    {
        question: "STL map.erase(iterator) works in:",
        code: "",
        answer: "O(n)\n\nO(1)\n\nO(log n)\n\nUndefined",
        correctAnswer: "O(log n)"
    },
    {
        question: "Using unordered_map<string, int> to count words gives what time complexity?",
        code: "",
        answer: "O(1)\n\nO(n) average\n\nO(n log n)\n\nO(n²)",
        correctAnswer: "O(n) average"
    },
    {
        question: "STL stack is implemented using:",
        code: "",
        answer: "vector\n\ndeque\n\nlist\n\nAll of them",
        correctAnswer: "deque"
    },
    {
        question: "Sorting array of structs with compare by two fields needs:",
        code: "",
        answer: "Lexicographical comparator\n\nBuilt-in sort\n\nmap\n\nprefix sum",
        correctAnswer: "Lexicographical comparator"
    },
    {
        question: "What is the risk in coordinate compression with large gaps?",
        code: "",
        answer: "Wrong indices\n\nHigh memory\n\nToo many operations\n\nSlow access",
        correctAnswer: "Wrong indices"
    }
];
